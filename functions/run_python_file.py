...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Executes a Python file within the permitted working directory and returns its output (stdout and stderr). Only .py files can be executed.",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "file_path": types.Schema(
                type=types.Type.STRING,
                description="The relative path of the Python file to run (e.g., 'main.py').",
            ),
            "args": types.Schema(
